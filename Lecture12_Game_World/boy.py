...
event_name = ['RIGHT_DOWN', 'LEFT_DOWN', 'RIGHT_UP', 'LEFT_UP', 'SLEEP_TIMER', 'SHIFT_UP', 'SHIFT_DOWN', 'DASH_TIMER',
              'DEBUG_KEY', 'SPACE']
...
next_state_table = {
    DashState: {LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState, LEFT_UP: IdleState, RIGHT_UP: IdleState,
                SHIFT_UP: RunState, SHIFT_DOWN: DashState, DASH_TIMER: RunState, SPACE: DashState},
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState,
                SLEEP_TIMER: SleepState, SHIFT_UP: IdleState, SHIFT_DOWN: IdleState, SPACE: IdleState},
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SHIFT_DOWN: DashState, SHIFT_UP: DashState, SPACE: RunState},
